...
export function Hero({
  ...
  // Note: particles array removed as it was unused in current implementation
          ...
          <div className="space-y-8 slide-in-left">
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                <h1 className="relative text-6xl lg:text-8xl font-black text-white leading-tight tracking-tight">
                  Hi, I&apos;m{" "}
                  <span className="relative">
                    ...
                    <span className="absolute inset-0 bg-gradient-to-r from-blue-400 via-cyan-400 to-sky-400 bg-clip-text text-transparent blur-md opacity-50 animate-pulse" style={{animationDelay: '0.5s'}}></span>

                    {/* Main text */}
                    <span className="relative bg-gradient-to-r from-blue-400 via-cyan-400 to-slate-300 bg-clip-text text-transparent animate-pulse drop-shadow-2xl">
                      Watchara
                    </span>
                  </span>
                </h1>
              ...
              <div className="relative">
                <h2 className="text-2xl lg:text-3xl text-gray-300 font-light tracking-wide">
                  <span className="text-blue-400 font-medium">{jobTitle}</span>
                </h2>
            ...
            <div className="flex items-center gap-8 pt-10">
              <span className="text-indigo-300 text-sm font-medium tracking-wider">CONNECT WITH ME</span>
