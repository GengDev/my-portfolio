        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="relative">
            <div className="bg-slate-800/50 rounded-3xl p-8 border border-slate-700/50 hover:border-cyan-400/30 transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/20">
              {/* Timeline Dot */}
              <div className="absolute -left-4 top-8 w-8 h-8 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full border-4 border-black flex items-center justify-center">
                ...
                <div className="mb-4 lg:mb-0">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-cyan-400 font-semibold">Khonkaen University</p>
                    </div>
                  </div>
          ...
          {/* High School */}
          <div className="relative">
            <div className="bg-slate-800/50 rounded-3xl p-8 border border-slate-700/50 hover:border-sky-400/30 transition-all duration-500 hover:shadow-2xl hover:shadow-sky-500/20">
              {/* Timeline Dot */}
              <div className="absolute -left-4 top-8 w-8 h-8 bg-gradient-to-r from-sky-500 to-cyan-500 rounded-full border-4 border-black flex items-center justify-center">
                <div className="w-3 h-3 bg-white rounded-full"></div>
              </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div className="mb-4 lg:mb-0">
                  <div className="flex items-center gap-4 mb-2">
                    <div className="w-16 h-16 bg-gradient-to-r from-sky-500 to-cyan-500 rounded-2xl flex items-center justify-center">
                      <span className="text-white font-bold text-xl">📚</span>
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-white">High School (Science-Mathematics)</h3>
                      <p className="text-sky-400 font-semibold">Thabo School</p>
                    </div>
                  </div>
